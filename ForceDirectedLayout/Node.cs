...
public class SpotNode : Node {
	...
	public SpotNode(Color color) : base() {
	...
	public override void DrawNode(Graphics graphics, Rectangle bounds) {
        ...
        graphics.DrawString(base.ID.ToString(), new Font("SansSerif",9.0f), Brushes.Red, new PointF(bounds.Location.X, bounds.Location.Y));
	}
}